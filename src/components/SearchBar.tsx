...
export default function SearchBar() {
  ...
  return (
    <div className="relative flex items-center gap-2 animate-in fade-in slide-in-from-right-2">
      <div className="relative">
        ...
        <Input
          ...
          className="pl-8 pr-3 h-9 w-64 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600 text-sm"
        />
      </div>
      <Button
        variant="ghost"
